...
import { modelProviderStructuredOutputs } from "../../../application/model-provider/index.js";
import type { ConversationReply, TaskSelection } from "../../../domain/index.js";
import {
...
/**
 * Creates the OpenAI-backed Vercel AI SDK model provider from validated runtime configuration.
 */
export function createOpenAiModelProvider(
  config: AppConfig,
): VercelAiSdkOpenAiModelProvider {
  return new VercelAiSdkOpenAiModelProvider({
